...
dependencies {
    ...
    implementation("com.google.android.gms:play-services-maps:${rootProject.ext["maps_services_version"]}")
    implementation("com.google.android.gms:play-services-location:${rootProject.ext["location_services_version"]}")
